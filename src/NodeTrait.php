...
trait NodeTrait {
     ...
     * @var string
     */
    public static $parentId = 'parent_id';
     ...
     * @return bool
     */
    public static function getIsSoftDelete()
    {
        $instance = new static;
     ...
     */
    public static function signOnEvents()
    {
     ...
     * @return bool
     */
    protected function actionAppendTo(self $parent)
    {
     ...
     * @return bool
     */
    protected function actionPrependTo(self $parent)
    {
    ...
    {
        $this->attributes[static::$parentId] = $value ? $value->getKey() : null;
     ...
     * @return bool
     */
    protected function actionBefore(self $node)
    {
     ...
     * @return bool
     */
    protected function actionAfter(self $node)
    {
    ...
    {
        return $this->belongsTo(get_class($this), static::$parentId);
    }
    ...
    {
        return $this->hasMany(get_class($this), static::$parentId);
    }
    ...
    public function siblings($dir = null)
    {
        ...
        $query->where(static::$parentId, '=', $this->getParentId());
     ...
     *
     */
    public static function create(array $attributes = array(), self $parent = null)
    {
    ...
    {
        if ($this->getAttribute(static::$parentId) != $value)
        {
            if ($value)
            {
            ...
            $this->attributes[static::$parentId] = $value;
        }
    }
    ...
    {
        return $this->getAttribute(static::$parentId) === null;
    }
    ...
    {
        return $this->getAttribute(static::$parentId);
    }
     ...
     * 
     * @param null|int|NodeTrait
     * @return bool
     */
    public static function hasTrait($node)
    {
        return (!is_null($node) && in_array(\Kalnoy\Nestedset\NodeTrait::class, (array)$node) === true);
    }
}
